...
#ifndef AP_BENSON_DUAL_SOLVER_CDD_H_
#define AP_BENSON_DUAL_SOLVER_CDD_H_
...
class APBensonDualSolverCDD : public AbstractAPSolver, public ScalarizationSolverCDD {
public:
	APBensonDualSolverCDD(std::shared_ptr<AssignmentInstance> instance, double epsilon = 1E-6);

	virtual ~APBensonDualSolverCDD();
...
private:
	...
	DualBensonScalarizerCDD *dual_benson_solver_;
