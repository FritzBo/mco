...
public:
	AssignmentGenerator(unsigned int num_agents, double edge_probability, AbstractObjectiveVectorGenerator &objective_generator) :
		objective_generator_(objective_generator), edge_probability_(edge_probability), num_agents_(num_agents) { }

	std::shared_ptr<AssignmentInstance> create_instance();
