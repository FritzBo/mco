...
#ifndef __mco__cep_dual_benson__
#define __mco__cep_dual_benson__
...
class LexBoundedDijkstraSolverAdaptor {
public:
    LexBoundedDijkstraSolverAdaptor(const ogdf::Graph& graph,
...
Solve(const ogdf::Graph& graph,
    ...
    dual_benson_solver(LexDijkstraSolverAdaptor(graph,
                                                weights,
                                                source,
                                                target,
                                                linear_bounds,
...
#endif /* defined(__mco__cep_dual_benson__) */
