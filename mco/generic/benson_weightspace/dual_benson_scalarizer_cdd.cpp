...
DualBensonScalarizerCDD::DualBensonScalarizerCDD(ScalarizationSolverCDD &solver, unsigned int dimension, double epsilon) :
	dimension_(dimension), epsilon_(epsilon), solver_(solver), vertex_container(nullptr), vertices_(0), facets_(0) {
}

void DualBensonScalarizerCDD::Calculate_solutions(list<Point *> &solutions) {
	...
	vertex_container = new DualBensonVertexContainerCDD(value, dimension_, epsilon_);
